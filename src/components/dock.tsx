...
import { Dock as DockComponent, DockIcon } from "@/components/magicui/dock";
...
const DATA: {
  contact: {
    social: Record<string, { name: string; url: string; icon: React.FC<IconProps> }>;
  };
} = {
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Piarre/nextjs-starter",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
